...
<div id = "footer">
    <div class="container_16">
        <div class="grid_16" >
            ...
            <div class="grid_5">
                <br/><h2 style="color:blue">Safe and Secure Shopping</h2><p>
        ...
        <div id="clear"></div>
        <div class="grid_16">	
            <p style="color:yellow">Copyrights &copy; 2012 Pramojan Enterprises - The Online Megastore</p>
    </div>
</div>
</div>
